export enum AnalysisAction {
  ...
  GET_ANALYSES_PLATFORMS_SUCCESS = "GET_ANALYSES_PLATFORMS_SUCCESS",
  GET_ANALYSES_PLATFORMS_NOT_FOUND = "GET_ANALYSES_PLATFORMS_NOT_FOUND",
  GET_ANALYSES_PLATFORMS_HTTP_INTERNAL_ERROR = "GET_ANALYSES_PLATFORMS_HTTP_INTERNAL_ERROR",
  GET_ANALYSES_PLATFORMS_ERROR = "GET_ANALYSES_PLATFORMS_ERROR",
