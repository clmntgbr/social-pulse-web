export enum WorkspacesAction {
  ...
  LEAVE_WORKSPACE_NOT_FOUND = "LEAVE_WORKSPACE_NOT_FOUND",
  LEAVE_WORKSPACE_HTTP_INTERNAL_ERROR = "LEAVE_WORKSPACE_HTTP_INTERNAL_ERROR",
  LEAVE_WORKSPACE_ERROR = "LEAVE_WORKSPACE_ERROR",

  DELETE_WORKSPACE_SUCCESS = "DELETE_WORKSPACE_SUCCESS",
  DELETE_WORKSPACE_NOT_FOUND = "DELETE_WORKSPACE_NOT_FOUND",
  DELETE_WORKSPACE_HTTP_INTERNAL_ERROR = "DELETE_WORKSPACE_HTTP_INTERNAL_ERROR",
