...
export type UserActionTypes = SetWorkspacesLoadingStartAction | SetWorkspacesLoadingEndAction | GetUserSuccessAction | GetUserNotFoundAction | GetUserHttpInternalErrorAction | GetUserErrorAction;
